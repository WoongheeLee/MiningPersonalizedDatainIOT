...
//			System.out.println();
	...
	public static void printGenre(TreeMap<Integer,ArrayList<String>> data) {
		Iterator<Integer> itr = data.keySet().iterator();
		while(itr.hasNext()) {
			int key = itr.next();
	...
	public static Matrix getGenre(TreeMap<Integer,ArrayList<String>> data) {
		Iterator<Integer> itr = data.keySet().iterator();
...
//			System.out.println();
	...
	public static Matrix getReleaseYear(TreeMap<Integer,ArrayList<String>> data) {
		Iterator<Integer> itr = data.keySet().iterator();
...
//		System.out.println(userItem.getRowDimension()+ "\t"+ userItem.getColumnDimension());
	...
	public static Matrix getMatrixMerge(Matrix releaseYear, Matrix genre) {
...
//			System.out.println();
	...
	public static double getCosineSimilarity(int activeUser, int dataUser, Matrix mat) {
	...
	public static double getAdjCosSim(int activeItem, int dataItem, Matrix mat) {
		double similarity = 0d;
	...
	public static double prediction(int activeUser, int itemID, Matrix userItem) {
		...
		for(int j = 0; j < userItem.getRowDimension(); j++) {
			int dataUser = j;
			if(activeUser-1 != j) {
				if(getCosineSimilarity(activeUser, dataUser, userItem) > 0.9999999) {
...
//		return Math.round(pred);
	...
	public static Matrix getAdjustedMatrix(Matrix mat) {
...
//		printMinDist(genre);
		...
		for(int i = 0; i < testCorrect.getRowDimension(); i++) {
			...
			double pred = prediction((int)testCorrect.get(i,0), (int)testCorrect.get(i,1), userItem);
